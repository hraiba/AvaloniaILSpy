...
{
    static readonly Dictionary<MessageBoxButton, string[]> Buttons = new()
    {
    ...
    static readonly Dictionary<MessageBoxButton, int> AcceptButtonID = new()
    {
    ...
    static readonly Dictionary<MessageBoxButton, int> CancelButtonID = new()
    {
    ...
    public static async Task<MessageBoxResult> Show(Window owner, string messageBoxText, string caption, MessageBoxButton button, MessageBoxImage icon, MessageBoxResult defaultResult, MessageBoxOptions options)
    {
        ...
        var btnIndex = await win.ShowDialog<int?>(owner ?? Avalonia.Application.Current.GetMainWindow());
