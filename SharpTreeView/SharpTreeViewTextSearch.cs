...
/// </summary>
public sealed class SharpTreeViewTextSearch : AvaloniaObject
{
    ...
    public bool Search(string nextChar)
    {
        ...
        bool lookBackwards = inputStack.Count > 0 && string.Equals(inputStack.Peek(), nextChar, StringComparison.OrdinalIgnoreCase);
